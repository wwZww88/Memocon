...
<|start_header_id|>assistant<|end_header_id|>"""
    ...
    print_(f"Start running concept extraction for MCQ with {MODEL}.")
    ...
    with open(os.path.join(cb_dir, f"cb_concepts_{MODEL.replace('/', '_')}.json"), 'a') as f:
        for i in indices:
